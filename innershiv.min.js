...
if(u===false){return e.childNodes;}var f=r.cloneNode(true),i=e.childNodes.length;while(i--){f.appendChild(e.firstChild);}return f;};}());
/*
 ...
 */
(function(a){a.fn.cloneShiv=function(){if(a.support.opacity){return a(this).clone();}else{return innerShiv(a("<div></div>").append(a(this)[0].cloneNode(true)).html().replace(/\:/g,""));}};})(jQuery);